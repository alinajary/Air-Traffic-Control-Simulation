...
unicycle_barrier_certificate = create_uni_barrier_certificate_with_boundary('SafetyRadius', 0.01);
...
% args = {'PositionError', 0.001, 'RotationError', 50};
args = {'PositionError', 0.02, 'RotationError', 150};
